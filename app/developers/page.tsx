...
import { Search, Star, MapPin, CheckCircle, ChevronDown, ChevronLeft, Briefcase, Calendar, Bookmark } from 'lucide-react'
...
export default function DevelopersPage() {
  ...
  const queryParams = useMemo(() => {
    ...
    if (selectedExperience) {
      // Experience filter based on completed tasks
      const minTasks = selectedExperience === 'beginner' ? 0 : selectedExperience === 'intermediate' ? 10 : 50
      // We'll filter client-side for now since API doesn't support this directly
    }
  ...
  // Client-side filtering for search query and experience
  ...
  // Get price range from developers
              ...
              <div className="bg-black rounded-3xl p-8 mb-6 relative overflow-hidden">
                <div className="relative z-10">
                  <h2 className="text-xl md:text-2xl font-bold text-white leading-tight mb-5">
                    Get Your best profession with Skillyy
                  </h2>
